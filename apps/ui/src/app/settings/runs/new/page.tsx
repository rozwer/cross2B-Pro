  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">新規Run作成</h1>
        <p className="text-gray-500 dark:text-gray-400 mt-1">SEO記事生成の設定を入力してください</p>
      </div>
